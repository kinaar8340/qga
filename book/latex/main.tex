...
\backmatter
\appendix
% Numbered as Appendix A, B, ... via \chapter after \appendix
% Our converter emits \chapter*{...} for kind=front; use chapter* style files
% but force appendix numbering with explicit titles in the MD (# Appendix A — ...)

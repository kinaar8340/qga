...
\author{Aaron Michael Kinder\\
  \texttt{https://github.com/qga-lab/qga}}
...
\begin{titlepage}
  ...
  Book repository: \url{https://github.com/qga-lab/qga}\par}
  \vspace{1.5cm}
...
\part{Foundations}
\input{chapters/ch00_preview}
\input{chapters/ch01_quaternions}
\input{chapters/ch02_hopf}

\part{The Gauged Hopf Lattice (The Farey Lift)}
\input{chapters/ch03_lattice}
\input{chapters/ch04_symmetries}

\part{Forms, Topographs, and Representations}
\input{chapters/ch05_topographs}
\input{chapters/ch06_classification}
\input{chapters/ch07_z_map}

\part{Arithmetic Depth}
\input{chapters/ch08_class_group}
\input{chapters/ch09_algebras}

\part{Observations and Models}
\input{chapters/ch10_observations}

% ---------- Appendices (still in main matter so A.1 / C.1 number) ----------
\appendix
\input{chapters/app_a_terminology}
\input{chapters/app_b_open_problems}
\input{chapters/app_c_labs}
\input{chapters/app_d_validation}
\input{chapters/app_e_figures}
\input{chapters/app_f_hatcher}
...
\begin{itemize}[leftmargin=*]
  ...
  \item This book repository: \url{https://github.com/qga-lab/qga}.
\end{itemize}

...
| Resource | Location |
|----------|----------|
| Kingdom Come | https://github.com/kinaar8340/kingdom_come · extra `.[portal]` |
| Shared Hopf / quaternion core | `flux-hopf-lib` (same extra) |

---

## 3. Running the labs

### 3.1 One install path
...
4. **Regenerate.** From repo root run `python3 scripts/generate_ch1_figures.py`. Chapters 7 and 10 may need the portal extra: `python3 scripts/generate_ch7_figures.py`.
...
| \(W_g\) | \(350/\pi\) (not \(350\pi\)) topological clock (**Hypothesis** H1a–H1e; Ch. 10) |

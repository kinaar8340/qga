...
### Lab 2.A–B — Hopf image and fiber
...
### Lab 4.D — Flux push-forward + OP1 equivariance
...
| Symptom | Fix |
|---------|-----|
| `ModuleNotFoundError: lib` | `sys.path` or run from repo root |
| `ModuleNotFoundError: kingdom` | Set `PYTHONPATH` or use kingdom venv |
